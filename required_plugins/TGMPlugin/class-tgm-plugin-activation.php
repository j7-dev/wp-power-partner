...
if ( ! class_exists( __NAMESPACE__ . '\TGM_Plugin_Activation' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	final class TGM_Plugin_Activation {
...
if ( ! class_exists( __NAMESPACE__ . '\TGMPA_List_Table' ) ) {
	 ...
	 * @author  Gary Jones
	 */
	final class TGMPA_List_Table extends \WP_List_Table {
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-activate' === $this->current_action() ) {
				...
				if ( is_wp_error( $activate ) ) {
					...
					$plugin_names = array_map( array( __NAMESPACE__ . '\TGMPA_Utils', 'wrap_in_strong' ), $plugin_names );
...
if ( ! class_exists( __NAMESPACE__ . '\TGM_Bulk_Installer' ) ) {
	 ...
	 */
	final class TGM_Bulk_Installer {
...
if ( ! class_exists( __NAMESPACE__ . 'TGM_Bulk_Installer_Skin' ) ) {
	 ...
	 *            For more information, see that class.}}
	 */
	final class TGM_Bulk_Installer_Skin {
	...
	function tgmpa_load_bulk_installer() {
		...
		if ( isset( $_GET['page'] ) && $tgmpa_instance->menu === $_GET['page'] ) {
			...
			if ( ! class_exists( __NAMESPACE__ . '\TGMPA_Bulk_Installer' ) ) {
				 ...
				 * @author  Gary Jones
				 */
				final class TGMPA_Bulk_Installer extends \Plugin_Upgrader {
			...
			if ( ! class_exists( __NAMESPACE__ . '\TGMPA_Bulk_Installer_Skin' ) ) {
				 ...
				 * @author  Gary Jones
				 */
				final class TGMPA_Bulk_Installer_Skin extends \Bulk_Upgrader_Skin {
